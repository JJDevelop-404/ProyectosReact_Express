...
export const getProductos = async () => {
    try {
        const lstProductos = await axios.get(`${import.meta.env.VITE_BACK_URL}/productos/getProductos`);
...
export const nuevoProducto = async (objProducto) => {
    ...
    try {
        const isInsert = await axios.post(`${import.meta.env.VITE_BACK_URL}/productos/createProducto`, objProducto);
...
export const modificarProducto = async (productoId, objProducto) => {
    ...
    try {
        const isEdit = await axios.put(`${import.meta.env.VITE_BACK_URL}/productos/updateProducto/${productoId}`, objProducto);
...
export const inactivarProducto = async (productoId) => { 
    try {
        const isDelete = await axios.delete(`${import.meta.env.VITE_BACK_URL}/productos/deleteProducto/${productoId}`);
